...
import com.mycompany.view.Staff.component.*; 
...
public class SaleFrame extends JFrame {
    ...
    private void initUI() {
        ...
        // --- CỘT TRÁI ---
                pnlCart = new CartPanel(
            cartItems,
            () -> switchToPayment(),        // onCheckout
            (item, newQty) -> updateQty(item, newQty), // onQtyChange
            (item) -> removeItem(item)     // onDelete
        );
